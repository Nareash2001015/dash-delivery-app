...
import { CreateShipmentModelProps, ShipmentInfo } from "../types";
import { useContext, useState } from "react";
import { AuthContext } from "../provider/AuthProvider";
import { createShipmentApi } from "../apis/ShipmentApi";
import { useNavigate } from "react-router-dom";

const CreateShipmentModel: React.FC<CreateShipmentModelProps> = ({
  setIsOpen,
  isOpen,
  userInfo,
  setShipmentInfo,
  ...
  const handleCreateShipment = async () => {
    try {
      ...
      setShipmentInfo((prevShipmentInfo) => [...prevShipmentInfo, response]);
      setIsOpen(false);
      setRecipientName("");
      setRecipientAddress("");
